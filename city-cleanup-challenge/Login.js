...
const styles = StyleSheet.create({
  ...
  logo: {
    ...
    alignItems: 'center',
    gap: 16,
    backgroundColor: 'rgba(21, 63, 99, 0.72)',
    borderColor: '#315F87',
    borderWidth: 1,
    borderRadius: 20,
    marginBottom: 24,
  ...
  logoMark: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: '#0C2946',
    borderRadius: 16,
  },
  logoMarkIcon: { color: '#61D6C6', fontSize: 31, fontWeight: '600' },
  logoName: { color: '#DCEBFC', fontSize: 16, fontWeight: '700', letterSpacing: 1.8 },
  logoTagline: { color: '#8EABC6', fontSize: 12, marginTop: 4 },
  title: {
    maxWidth: 500,
    color: '#F5F8FF',
    fontSize: Platform.OS === 'web' ? 40 : 32,
    fontWeight: '600',
    lineHeight: Platform.OS === 'web' ? 48 : 39,
    letterSpacing: -1,
  ...
  impactItem: { color: '#72D7CA', fontSize: 13, fontWeight: '600' },
  card: {
    width: '100%',
    maxWidth: 460,
  ...
  cardTitle: { color: '#F5F8FF', fontSize: 28, fontWeight: '600' },
  cardSubtitle: { color: '#93A9C0', fontSize: 14, marginBottom: 24, marginTop: 6 },
  fieldGroup: { marginBottom: 17 },
  label: { color: '#D9E6F5', fontSize: 14, fontWeight: '600', marginBottom: 8 },
  input: {
    width: '100%',
    minHeight: 52,
  ...
  dividerText: { color: '#7890AA', fontSize: 10, fontWeight: '600', letterSpacing: 1 },
  secondaryButton: {
    minHeight: 52,
    alignItems: 'center',
    justifyContent: 'center',
