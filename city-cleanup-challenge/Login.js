...
const styles = StyleSheet.create({
  ...
  markIcon: { color: '#61D6C6', fontSize: 34, fontWeight: '600' },
  badge: {
  ...
  badgeText: { color: '#8DBDFF', fontSize: 11, fontWeight: '600', letterSpacing: 1.7 },
  title: {
    maxWidth: 500,
    color: '#F5F8FF',
  ...
  cardEyebrow: { color: '#69B4FF', fontSize: 11, fontWeight: '600', letterSpacing: 1.6 },
  cardTitle: { color: '#F5F8FF', fontSize: 28, fontWeight: '600', marginTop: 8 },
