...
export interface Validators extends Contract {
    ...
    methods: {
        ...
        deprecated_downtimeGracePeriod(): CeloTxObject<string>;
        ...
        initialize(registryAddress: string, groupRequirementValue: number | string, groupRequirementDuration: number | string, validatorRequirementValue: number | string, validatorRequirementDuration: number | string, _membershipHistoryLength: number | string, _slashingMultiplierResetPeriod: number | string, _maxGroupSize: number | string, initParams: {
