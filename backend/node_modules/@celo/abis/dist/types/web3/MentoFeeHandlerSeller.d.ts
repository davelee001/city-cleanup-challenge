...
export interface MentoFeeHandlerSeller extends Contract {
    ...
    methods: {
        ...
        getOracleAddress(_tokenAddress: string): CeloTxObject<string>;
        ...
        oracleAddresses(arg0: string): CeloTxObject<string>;
        ...
        setOracleAddress(_tokenAddress: string, _oracleAddress: string): CeloTxObject<void>;
    ...
    events: {
        ...
        OracleAddressSet: ContractEvent<{
            _token: string;
            _oracle: string;
            0: string;
            1: string;
